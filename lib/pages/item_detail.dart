    ...
    Widget _reviewTile(){
      return Container(
        child: Column(children: <Widget>[
          Row(children: <Widget>[
            Icon(Icons.image),
            Text("Renter Name", style: TextStyle(fontFamily: 'Quicksand'),)
          ],),
          Text("Customer Review Goes Here", style: TextStyle(fontFamily: 'Quicksand')),
        ],),
      );
    }
    return Container(
      ...
      child: Column(children: <Widget>[
        ...
        Align(alignment: Alignment.bottomRight,
          child: InkWell(onTap: ()=>null,
            child: Text('View All', style: TextStyle(fontFamily: 'Quicksand', color: primaryColor))
        ))
      ],),
    );
  }
