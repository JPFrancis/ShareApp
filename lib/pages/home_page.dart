  ...
  Widget profileIntroStream() {
    Widget showPersonalInformation() {
      ...
      return Column(children: <Widget>[
        ...
        Center(child: Text("${myUserDS['name']}", style: TextStyle(fontFamily: font, fontSize: width / 15))),
        Center(child: Text('${myUserDS['email']}', style: TextStyle(color: Colors.black, fontSize: width / 27, fontFamily: 'Quicksand'))),
        SizedBox(height: 5.0,),
        Center(child: Column(children: <Widget>[
          Align(alignment: Alignment.topLeft, child: Icon(QuoteIcons.quote_left, size: width / 22,)),
          ...
          Align(alignment: Alignment.bottomRight, child: Icon(QuoteIcons.quote_right, size: width / 22,)),
        ])),
        SizedBox(height: 10.0,),
        Container(
        color: Colors.white,
                ...
                return Stack(children: <Widget>[
                  ...
                  Align(
                    ...
                    child: OutlineButton(
                      ...
                      child: Text("Edit Profile", style: TextStyle(fontFamily: 'Quicksand', fontWeight: FontWeight.normal))),
                  ),
                ],);
